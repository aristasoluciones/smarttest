            ...
            <div class="portlet-body form">
                ...
                <input type="hidden" name="id" id="id" value="{$info.idReg}" />
					...
					<div class="control-group">
                        ...
                        <div class="controls">
                        	{if !$info.view}
                            <input type="text" class="m-wrap span12" onClick="fnFechaNa()" id="fechanacimiento" name="fechanacimiento" value="{$info.fechanacimiento}" maxlength="60" />
                            {else}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <select class="m-wrap span12" name="tipo" id="tipo" onchange="ShowEstablo(this.value)" >
                                ...
                                <option value="publico" {if $info.tipo == "publico"}selected{/if}>Publico</option>                                
                            </select> 
                             {else}
                            	{$info.tipo}
                            {/if}
