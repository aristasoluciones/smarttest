...
<table class="table table-striped table-bordered table-hover" id="sample_3">
    ...
    <tbody>
        ...
        <tr class="odd gradeX">
            ...
            <td><div align="center">
			{if $item.autorizado eq "no"}
            <a href="javascript:void(0)" onClick="autorizarVer({$item.solicitudarchivoId})" title="AUTORIZAR">
            	<img src="{$WEB_ROOT}/images/tick-button.png" border="0">
            </a>
			{else}
			<a href="javascript:void(0)" title="AUTORIZAR">
            	<img src="{$WEB_ROOT}/images/blue-document-pdf-text.png" border="0">
            </a>
            {/if}
			
				<!--
			<a href="javascript:void(0)" onClick="solicitar({$item.tipodocumentoId})" title="Eliminar">
