...
<table class="table table-striped table-bordered table-hover" id="sample_3">
    ...
    <tbody>
    	{foreach from=$registrosDep.result item=item key=key}        	
        <tr class="odd gradeX">
            ...
            <a href="javascript:void(0)" onClick="ViewRegDep({$item.dependenciaId})" title="Ver Detalles">
            	<img src="{$WEB_ROOT}/images/icons/view.png" border="0">
            </a>
            <a href="javascript:void(0)" onClick="EditRegDep({$item.dependenciaId})" title="Editar">
            	<img src="{$WEB_ROOT}/images/icons/edit.png" border="0">
            </a>
			 <a href="javascript:void(0)" onClick="unificar({$item.dependenciaId})" title="UNIFICAR">
            	<img src="{$WEB_ROOT}/images/arrow-switch-180.png" border="0">
            </a>
            <a href="javascript:void(0)" onClick="DeleteRegDep({$item.dependenciaId})" title="Eliminar">
