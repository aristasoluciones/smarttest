...
<table class="table table-striped table-bordered table-hover" id="sample_3">
    ...
    <tbody>
        ...
        <tr class="odd gradeX">
            ...
            <td><div align="center">
			{if $item.existeArchivo eq "si"}
            <a href="{$WEB_ROOT}/documentos/{$item.ruta}"  target="_blank" title="Ver Documento"> 
            ...
            <a href="javascript:void(0)" onClick="DeleteReg({$item.documentoId})" title="Eliminar">
				...
				<a href="javascript:void(0)" onClick="closeOpen({$item.documentoId},'no')" title="PRIVADO">
					 <img src="{$WEB_ROOT}/images/open.jpg" border="0">
				</a>
				{else}
				<a href="javascript:void(0)" onClick="closeOpen({$item.documentoId},'si')" title="PUBLICO">
