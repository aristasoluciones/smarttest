            ...
            <div class="portlet-body form">
                ...
                <input type="hidden" name="id" id="id" value="{$info.idReg}" />
                    <div class="control-group">
                        ...
                        <div class="controls">
                        	{if !$info.view}
                            <input type="text" class="m-wrap span12" name="nombre" value="{$info.info.nombre}" maxlength="60" />
                            {else}
                            	{$info.nombre}
                            {/if}
                        </div>
					 ...
					 <div class="control-group">
                        ...
                        <div class="controls">
                        	{if !$info.view}
                            <input type="text" class="m-wrap span12" name="direccion" value="{$info.info.direccion}" maxlength="60" />
                            {else}
                            	{$info.direccion}
                            {/if}
                        </div>
