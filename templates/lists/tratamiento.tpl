...
<table class="table table-striped table-bordered table-hover" id="sample_3">
    ...
    <tbody>
        ...
        <tr class="odd gradeX">
            <td>{$item.numTratamiento}</td>
            <td>{$item.nombre}</td>
            <td><div align="center">{$item.productos}</div></td>
            <td><div align="center">${$item.costo|number_format:2:'.':','}</div></td>
            <td><div align="center">{$item.diaDescarte}</div></td>
            <td><div align="center">{$item.observacion}</div></td>
            <td><div align="center">
